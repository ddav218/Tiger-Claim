...
function getUrlBasedHistory(getLocation, createHref, validateLocation, options) {
  ...
  function createURL(to) {
    ...
    !base ? process.env.NODE_ENV !== "production" ? invariant$2(false, "No window.location.(origin|href) available to create URL for href: " + href) : invariant$2(false) : void 0;
...
function convertRoutesToDataRoutes(routes, mapRouteProperties, parentPath, manifest) {
  ...
  return routes.map((route, index) => {
    ...
    !(route.index !== true || !route.children) ? process.env.NODE_ENV !== "production" ? invariant$2(false, "Cannot specify children on an index route") : invariant$2(false) : void 0;
    !!manifest[id] ? process.env.NODE_ENV !== "production" ? invariant$2(false, "Found a route id collision on id \"" + id + "\".  Route " + "id's must be globally unique within Data Router usages") : invariant$2(false) : void 0;
...
function flattenRoutes(routes, branches, parentsMeta, parentPath) {
  ...
  let flattenRoute = (route, index, relativePath) => {
    ...
    if (meta.relativePath.startsWith("/")) {
      !meta.relativePath.startsWith(parentPath) ? process.env.NODE_ENV !== "production" ? invariant$2(false, "Absolute route path \"" + meta.relativePath + "\" nested under path " + ("\"" + parentPath + "\" is not valid. An absolute child route path ") + "must start with the combined path of all its parent routes.") : invariant$2(false) : void 0;
...
function decodePath(value) {
  try {
    ...
    process.env.NODE_ENV !== "production" ? warning(false, "The URL path \"" + value + "\" could not be decoded because it is is a " + "malformed URL segment. This is probably due to a bad percent " + ("encoding (" + error + ").")) : void 0;
    return value;
  }
}
/**
...
function resolveTo(toArg, routePathnames, locationPathname, isPathRelative) {
  ...
  if (typeof toArg === "string") {
    ...
    to = _extends({}, toArg);
    !(!to.pathname || !to.pathname.includes("?")) ? process.env.NODE_ENV !== "production" ? invariant$2(false, getInvalidPathError("?", "pathname", "search", to)) : invariant$2(false) : void 0;
    !(!to.pathname || !to.pathname.includes("#")) ? process.env.NODE_ENV !== "production" ? invariant$2(false, getInvalidPathError("#", "pathname", "hash", to)) : invariant$2(false) : void 0;
    !(!to.search || !to.search.includes("#")) ? process.env.NODE_ENV !== "production" ? invariant$2(false, getInvalidPathError("#", "search", "hash", to)) : invariant$2(false) : void 0;
  }
...
function createRouter(init) {
  ...
  function initialize() {
    ...
    unlistenHistory = init.history.listen(_ref => {
      ...
      process.env.NODE_ENV !== "production" ? warning(blockerFunctions.size === 0 || delta != null, "You are trying to use a blocker on a POP navigation to a location " + "that was not created by @remix-run/router. This will fail silently in " + "production. This can happen if you are navigating outside the router " + "via `window.history.pushState`/`window.location.hash` instead of using " + "router navigation APIs.  This can also happen if you are using " + "createHashRouter and the user manually changes the URL.") : void 0;
  ...
  async function handleFetcherAction(key, routeId, path, match, requestMatches, isFogOfWar, flushSync, preventScrollReset, submission) {
    ...
    !matches ? process.env.NODE_ENV !== "production" ? invariant$2(false, "Didn't find any matches after fetcher action") : invariant$2(false) : void 0;
    ...
    if (state.navigation.state === "loading" && loadId > pendingNavigationLoadId) {
      !pendingAction ? process.env.NODE_ENV !== "production" ? invariant$2(false, "Expected pending action") : invariant$2(false) : void 0;
      pendingNavigationController && pendingNavigationController.abort();
  ...
  async function startRedirectNavigation(request, redirect, isNavigation, _temp2) {
    ...
    !location ? process.env.NODE_ENV !== "production" ? invariant$2(false, "Expected a Location header on the redirect Response") : invariant$2(false) : void 0;
  ...
  function markFetchRedirectsDone() {
    ...
    for (let key of fetchRedirectIds) {
      let fetcher = state.fetchers.get(key);
      !fetcher ? process.env.NODE_ENV !== "production" ? invariant$2(false, "Expected fetcher: " + key) : invariant$2(false) : void 0;
  ...
  function shouldBlockNavigation(_ref2) {
    ...
    if (blockerFunctions.size > 1) {
      process.env.NODE_ENV !== "production" ? warning(false, "A router only supports one blocker at a time") : void 0;
    }
...
function createStaticHandler$1(routes, opts) {
  ...
  async function queryImpl(request, location, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch) {
    !request.signal ? process.env.NODE_ENV !== "production" ? invariant$2(false, "query()/queryRoute() requests must contain an AbortController signal") : invariant$2(false) : void 0;
    try {
...
function normalizeNavigateOptions(isFetcher, path, opts) {
  ...
  !(typeof FormData === "function") ? process.env.NODE_ENV !== "production" ? invariant$2(false, "FormData is not available in this environment") : invariant$2(false) : void 0;
  let searchParams;
  let formData;
  if (opts.formData) {
...
function patchRoutesImpl(routeId, children, routesToUse, manifest, mapRouteProperties) {
  ...
  if (routeId) {
    ...
    !route ? process.env.NODE_ENV !== "production" ? invariant$2(false, "No route found to patch children into: routeId = " + routeId) : invariant$2(false) : void 0;
    if (!route.children) {
      route.children = [];
    }
...
async function loadLazyRouteModule(route, mapRouteProperties, manifest) {
  ...
  for (let lazyRouteProperty in lazyRoute) {
    ...
    process.env.NODE_ENV !== "production" ? warning(!isPropertyStaticallyDefined, "Route \"" + routeToUpdate.id + "\" has a static property \"" + lazyRouteProperty + "\" " + "defined but its lazy function is also returning a value for this property. " + ("The lazy route property \"" + lazyRouteProperty + "\" will be ignored.")) : void 0;
...
function normalizeRelativeRoutingRedirectResponse(response, request, routeId, matches, basename) {
  ...
  !location ? process.env.NODE_ENV !== "production" ? invariant$2(false, "Redirects returned/thrown from loaders/actions must have a Location header") : invariant$2(false) : void 0;
...
function processRouteLoaderData(matches, results, pendingActionResult, isStaticHandler, skipLoaderErrorBubbling) {
  ...
  matches.forEach(match => {
    ...
    !!isRedirectResult(result) ? process.env.NODE_ENV !== "production" ? invariant$2(false, "Cannot handle redirect results in processLoaderData") : invariant$2(false) : void 0;
    if (isErrorResult(result)) {
...
function processLoaderData(state, matches, results, pendingActionResult, revalidatingFetchers, fetcherResults) {
  ...
  revalidatingFetchers.forEach(rf => {
    ...
    if (controller && controller.signal.aborted) {
      ...
      process.env.NODE_ENV !== "production" ? invariant$2(false, "Unhandled fetcher revalidation redirect") : invariant$2(false) ;
    } else {
...
function persistAppliedTransitions(_window, transitions) {
  if (transitions.size > 0) {
    ...
    try {
      ...
      process.env.NODE_ENV !== "production" ? warning(false, "Failed to save applied view transitions in sessionStorage (" + error + ").") : void 0;
    }
  }
}
...
function useHref(to, _temp) {
  ...
  !useInRouterContext() ? process.env.NODE_ENV !== "production" ? invariant$2(false, // TODO: This error is probably because they somehow have 2 versions of the
  // router loaded. We can help them understand how to avoid that.
  "useHref() may be used only in the context of a <Router> component.") : invariant$2(false) : void 0;
  let {
    basename,
    navigator
...
function useMatch(pattern) {
  !useInRouterContext() ? process.env.NODE_ENV !== "production" ? invariant$2(false, // TODO: This error is probably because they somehow have 2 versions of the
  // router loaded. We can help them understand how to avoid that.
  "useMatch() may be used only in the context of a <Router> component.") : invariant$2(false) : void 0;
  let {
    pathname
  } = useLocation();
...
function useNavigateUnstable() {
  !useInRouterContext() ? process.env.NODE_ENV !== "production" ? invariant$2(false, // TODO: This error is probably because they somehow have 2 versions of the
  // router loaded. We can help them understand how to avoid that.
  "useNavigate() may be used only in the context of a <Router> component.") : invariant$2(false) : void 0;
...
function useRoutesImpl(routes, locationArg, dataRouterState, future) {
  !useInRouterContext() ? process.env.NODE_ENV !== "production" ? invariant$2(false, // TODO: This error is probably because they somehow have 2 versions of the
  // router loaded. We can help them understand how to avoid that.
  "useRoutes() may be used only in the context of a <Router> component.") : invariant$2(false) : void 0;
  let {
    navigator
  } = React.useContext(NavigationContext);
  let {
...
function useDataRouterContext$2(hookName) {
  ...
  !ctx ? process.env.NODE_ENV !== "production" ? invariant$2(false, getDataRouterConsoleError$1(hookName)) : invariant$2(false) : void 0;
  return ctx;
}
...
function Navigate(_ref5) {
  ...
  !useInRouterContext() ? process.env.NODE_ENV !== "production" ? invariant$2(false, // TODO: This error is probably because they somehow have 2 versions of
  // the router loaded. We can help them understand how to avoid that.
  "<Navigate> may be used only in the context of a <Router> component.") : invariant$2(false) : void 0;
  let {
    static: isStatic
  } = React.useContext(NavigationContext);
...
async function singleFetchActionStrategy(request, matches) {
  ...
  !actionMatch ? process.env.NODE_ENV !== "production" ? invariant$1(false, "No action match found") : invariant$1(false) : void 0;
...
async function singleFetchLoaderFetcherStrategy(request, matches) {
  ...
  !fetcherMatch ? process.env.NODE_ENV !== "production" ? invariant$1(false, "No fetcher match found") : invariant$1(false) : void 0;
...
function createServerRoutes(manifest, routeModules, future, isSpaMode, parentId, routesByParentId, spaModeLazyPromise) {
  ...
  return (routesByParentId[parentId] || []).map(route => {
    ...
    !routeModule ? process.env.NODE_ENV !== "production" ? invariant$1(false, "No `routeModule` available to create server routes") : invariant$1(false) : void 0;
...
function createClientRoutes(manifest, routeModulesCache, initialState, isSpaMode, parentId, routesByParentId, needsRevalidation) {
  ...
  return (routesByParentId[parentId] || []).map(route => {
    ...
    function fetchServerHandler(singleFetch) {
      !(typeof singleFetch === "function") ? process.env.NODE_ENV !== "production" ? invariant$1(false, "No single fetch function available for route handler") : invariant$1(false) : void 0;
      return singleFetch();
    }
    ...
    if (routeModule) {
      ...
      dataRoute.loader = async (_ref, singleFetch) => {
        ...
        try {
          let result = await prefetchStylesAndCallHandler(async () => {
            !routeModule ? process.env.NODE_ENV !== "production" ? invariant$1(false, "No `routeModule` available for critical-route loader") : invariant$1(false) : void 0;
      ...
      dataRoute.action = (_ref2, singleFetch) => {
        ...
        return prefetchStylesAndCallHandler(async () => {
          !routeModule ? process.env.NODE_ENV !== "production" ? invariant$1(false, "No `routeModule` available for critical-route action") : invariant$1(false) : void 0;
...
function useDataRouterContext$1() {
  ...
  !context ? process.env.NODE_ENV !== "production" ? invariant$1(false, "You must render this element inside a <DataRouterContext.Provider> element") : invariant$1(false) : void 0;
  return context;
}
...
/**
  ...
  @category Components
 */
const Link = /*#__PURE__*/React.forwardRef(function LinkWithRef(_ref4, forwardedRef) {
  let {
      onClick,
      discover = "render",
      prefetch = "none",
  ...
  React.createElement("a", _extends({}, rest, prefetchHandlers, {
...
@category Components
*/
const Form = /*#__PURE__*/React.forwardRef((_ref6, forwardedRef) => {
  let {
      discover = "render",
      fetcherKey,
      navigate,
...
function useViewTransitionState(to, opts) {
  ...
  !(vtContext != null) ? process.env.NODE_ENV !== "production" ? invariant$2(false, "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  " + "Did you accidentally import `RouterProvider` from `react-router`?") : invariant$2(false) : void 0;
  let {
    basename
...
function StaticRouterProvider(_ref2) {
  ...
  !(router && context) ? process.env.NODE_ENV !== "production" ? invariant$2(false, "You must provide `router` and `context` to <StaticRouterProvider>") : invariant$2(false) : void 0;
...
function createRoutesStub(routes, context) {
  ...
  return function RoutesTestStub(_ref) {
    ...
    return /*#__PURE__*/React.createElement(FrameworkContext.Provider, {
...
async function handleResourceRequest(serverMode, build, staticHandler, routeId, request, loadContext, handleError) {
  try {
    ...
    !isResponse(response) ? process.env.NODE_ENV !== "production" ? invariant(false, "Expected a Response to be returned from resource route handler") : invariant(false) : void 0;
    return response;
  } catch (error) {
    if (isResponse(error)) {
